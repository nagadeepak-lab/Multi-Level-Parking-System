...
export const parkVehicle = (vehicleNumber, vehicleType, phoneNumber, name, preferredFloor, preferredSlot) =>
  api.post('/parking/entry', { vehicleNumber, vehicleType, phoneNumber, name, preferredFloor, preferredSlot });
